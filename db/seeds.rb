...
# France
Restaurant.create(image_url: "https://img-4.linternaute.com/wE3UZdTethn99-heK4SqMUGjs2I=/fit-in/550x550/ef2dd3e3a3d742abb1fcadc508fd4016/restaurant/11744.jpg", name: "L'Oustau de Baumanière", address: "515 Route DE BAUMANIERE, 13520 Les Baux-de-Provence", phone_number: "04 90 54 33 07", country: "france")
...
Restaurant.create(image_url: "https://alexandertheguest.com/wp-content/uploads/2023/01/2021-10-01-18-02-35-167eec1dd12dc60ee5543c00ec7ad20b.jpeg", name: "AM par Alexandre Mazzia", address: "9 Rue François Rocca, 13008 Marseille", phone_number: "04 91 24 83 63", country: "france")
Restaurant.create(image_url: "https://www.ducasse-paris.com/sites/default/files/2019-10/louis-xv-img-mobile.jpg", name: "Le Louis XV - Alain Ducasse à l'Hôtel de Paris", address: "Place du Casino, 98000 Monaco", phone_number: "+377 98 06 88 64", country: "france")
...
Restaurant.create(image_url: "https://media-cdn.tripadvisor.com/media/photo-s/1d/4a/68/cc/caption.jpg", name: "Le Suquet - Sebastien Bras", address: "Route de Laguiole, 12210 Laguiole", phone_number: "05 65 51 18 20", country: "france")
...
Restaurant.create(image_url: "https://www.lelauracee.com/restaurants/d6295f03afd5e2087cd584e41b66c563/photos/8308/slide%20(4)_20181116110240.jpg", name: "Le Lauracée - Restaurant Marseille", address: "96 Rue Grignan, 13001 Marseille", phone_number: "0491336336", country: "france")
Restaurant.create(image_url: "https://fr.gaultmillau.com/download/6144409ebb6edc254539a394/image/jpeg/les-arcenaulx.jpg", name: "Restaurant Les Arcenaulx Marseille Vieux Port", address: "25 Cours Honoré d'Estienne d'Orves, 13001 Marseille", phone_number: "0491598030", country: "france")
...
Restaurant.create(image_url: "https://media-cdn.tripadvisor.com/media/photo-s/26/98/56/38/sala-principale.jpg", name: "Massimo's Al 39 Restaurant", address: "Via Palestro, 39/a 41/a, 00185 Roma RM, Italie", phone_number: "+39064441213", country: "italy")
...
Restaurant.create(image_url: "https://media-cdn.tripadvisor.com/media/photo-s/1d/bf/e9/ac/le-pizze-di-oggi.jpg", name: "Ristorante Pizzeria La Cucina Nazionale", address: "Via Nazionale, 3, 00184 Roma RM, Italie", phone_number: "+3906484452", country: "italy")
...
Restaurant.create(image_url: "https://media-cdn.tripadvisor.com/media/photo-s/1a/4a/8c/73/img-20191214-142251-largejpg.jpg", name: "Restaurant La Bruschetta", address: "Via Sardegna, 39, 00187 Roma RM, Italie", phone_number: "+390642013721", country: "italy")
